...
ALTER TABLE "identity_email_claim" ADD COLUMN "operation_id" text;--> statement-breakpoint
ALTER TABLE "identity_email_claim" ADD COLUMN "request_id" text;--> statement-breakpoint
ALTER TABLE "identity_email_claim" ADD COLUMN "ip_address" text;--> statement-breakpoint
ALTER TABLE "identity_email_claim" ADD COLUMN "user_agent" text;--> statement-breakpoint
